<template>
  <div class="return-view" :data-it-return-product="itReturnProduct">
    <h2 class="title">Order #{{ orderId }}</h2>
    <p class="expiration" :data-it-return-product-expiration="expirationDate">
      Return expires on: {{ expirationDate }}
    </p>
    <p class="lot" :data-it-return-product-lot="orderLot">
      Lot number: {{ orderLot }}
    </p>
    ...
    <ul class="product-list">
      <li v-for="prod in selectedProducts" :key="prod.id" class="product">
        ...
        <div
          class="product-info"
          :data-it-return-product-id="prod.id"
          :data-it-return-product-category="prod.cat"
          :data-it-return-product-quantity="prod.quantity"
          :data-it-product-stock-status="prod.stockStatus"
        >
    ...
    <textarea
      ...
      :data-it-return-product-reason="itReturnReason"
    ></textarea>
